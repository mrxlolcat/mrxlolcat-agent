    ...
    return (
      <div className="min-h-screen min-h-[100dvh] flex flex-col" style={{ background: "#09090B" }}>
        <nav className="glass sticky top-0 z-50 flex items-center gap-3 px-4 py-3 border-b border-zinc-800/60">
          ...
          <h1 className="font-semibold text-sm flex-1">🔄 Swap & Bridge</h1>
        </nav>
        <div className="flex-1 flex flex-col items-center justify-center px-6 text-center">
          ...
          <p className="text-sm text-zinc-400 mb-6 max-w-[260px]">Connect your wallet to swap and bridge tokens across 60+ chains instantly.</p>
    ...
    <div className="min-h-screen min-h-[100dvh] flex flex-col" style={{ background: "#09090B" }}>
      ...
      <nav className="glass sticky top-0 z-50 flex items-center gap-3 px-4 py-3 border-b border-zinc-800/60">
        ...
        <div className="flex-1">
          <h1 className="font-semibold text-sm">🔄 Swap & Bridge</h1>
